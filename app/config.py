...
DOWNLOAD_DIR = Path(os.environ.get("DOWNLOAD_DIR", str(BASE_DIR / "data" / "downloads"))).resolve()
...
DOUYIN_PLAYWRIGHT = os.environ.get("DOUYIN_PLAYWRIGHT", "true").lower() in ("1", "true", "yes")
